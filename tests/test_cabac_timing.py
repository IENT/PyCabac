...
class MainTest(unittest.TestCase):
    ...
    def _call_cabac_order1(self, fun='EGk'):
        ...
        # Binarization ID
        if (
            fun == 'TUBAC' or fun == 'TUBinPos' or fun == 'TUbinsOrder1' or
            fun == 'TUsymbolOrder1'
        ):
            bin_id = cabac.BinarizationId.TU
        elif (
            fun == 'EGkBAC' or fun == 'EGkBinPos' or fun == 'EGkbinsOrder1' or
            fun == 'EGksymbolOrder1'
        ):
        ...
        symbols = symbolgenerator.random_uniform(num_symbols, num_max_val)
        ...
        def ctx_id_wrapper(
                fun, n, symbol_prev, ctx_rest_pos, ctx_symbol_max, k=0
        ):
            if fun == 'TUBAC' or fun == 'EGkBAC':
                ctx_id = 0
            elif fun == 'TUBinPos' or fun == 'EGkBinPos':
                ctx_id = contextselector.ctx_id_bin_pos(
                    n=n, n_rst=ctx_rest_pos
                )
            elif fun == 'TUbinsOrder1':
                ctx_id = contextselector.ctx_id_bins_order_1_tu(
                    n=n, prev_symbol=symbol_prev, n_rst=ctx_rest_pos
                )
            elif fun == 'TUsymbolOrder1':
                ctx_id = contextselector.ctx_id_symbol_order_1_tu(
                    n=n, prev_symbol=symbol_prev, rest_pos=ctx_rest_pos,
                    symbol_max=ctx_symbol_max
                )
            elif fun == 'EGkbinsOrder1':
                ctx_id = contextselector.ctx_id_bins_order_1_egk(
                    n=n, prev_symbol=symbol_prev, n_rst=ctx_rest_pos, k=k
                )
            elif fun == 'EGksymbolOrder1':
                ctx_id = contextselector.ctx_id_symbol_order_1_egk(
                    n=n, prev_symbol=symbol_prev, rest_pos=ctx_rest_pos,
        ...
        for i, symbol in enumerate(symbols):
            ...
            for n, bin in enumerate(bins):
                # Context selection
                ctx_id = ctx_id_wrapper(
                    fun, n, symbol_prev, ctx_rest_pos, ctx_symbol_max, k
                )
        ...
        # TU encodes integer value v as a sequence of '1' of length v,
        # terminated by a '0'
        ...
        for i in range(0, num_symbols):
            ...
            n = 0
            ctx_id = ctx_id_wrapper(
                fun, n, symbol_prev_dec, ctx_rest_pos, ctx_symbol_max, k
            )
        ...
        def ctx_ids_wrapper(fun, n_array, symbol_prev, ctx_rest_pos,
                            ctx_symbol_max, k=0):
            if fun == 'TUBAC' or fun == 'EGkBAC':
                ctx_ids = np.zeros(n_array.shape, dtype=np.int32)
            elif fun == 'TUBinPos' or fun == 'EGkBinPos':
                ctx_ids = contextselector.ctx_ids_bin_pos(
                    n=n_array, n_rst=ctx_rest_pos
                )
            elif fun == 'TUbinsOrder1':
                ctx_ids = contextselector.ctx_ids_bins_order_1_tu(
                    n=n_array, prev_symbol=symbol_prev, n_rst=ctx_rest_pos
                )
            elif fun == 'TUsymbolOrder1':
                ...
                ctx_ids = contextselector.ctx_ids_bins_order_1_egk(
                    n=n_array, prev_symbol=symbol_prev, n_rst=ctx_rest_pos, k=k
                )
            elif fun == 'EGksymbolOrder1':
                ctx_ids = contextselector.ctx_ids_symbol_order_1_egk(
                    n=n_array, prev_symbol=symbol_prev, rest_pos=ctx_rest_pos,
                    symbol_max=ctx_symbol_max, k=k
                )
        ...
        symbol_prev = 0
        for i, symbol in enumerate(symbols):
            ctx_ids = ctx_ids_wrapper(
                fun, n_array, symbol_prev, ctx_rest_pos, ctx_symbol_max, k
            )
            if bin_id == cabac.BinarizationId.TU:
        ...
        for i in range(0, num_symbols):
            ctx_ids = ctx_ids_wrapper(
                fun, n_array, symbol_prev_dec, ctx_rest_pos, ctx_symbol_max, k
            )
        ...
        def ctx_fun_wrapper(fun, symbol_prev, ctx_rest_pos, ctx_symbol_max,
                            k=0):
            if fun == 'TUBAC' or fun == 'EGkBAC':
                ctx_fun = lambda n: 0
            elif fun == 'TUBinPos' or fun == 'EGkBinPos':
                ctx_fun = lambda n: contextselector.ctx_id_bin_pos(
                    n=n, n_rst=ctx_rest_pos
                )
            elif fun == 'TUbinsOrder1':
                ctx_fun = lambda n: contextselector.ctx_id_bins_order_1_tu(
                    n=n, prev_symbol=symbol_prev, n_rst=ctx_rest_pos
                )
            elif fun == 'TUsymbolOrder1':
                ctx_fun = lambda n: contextselector.ctx_id_symbol_order_1_tu(
                    n=n, prev_symbol=symbol_prev, rest_pos=ctx_rest_pos,
                    symbol_max=ctx_symbol_max
                )
            elif fun == 'EGkbinsOrder1':
                ctx_fun = lambda n: contextselector.ctx_id_bins_order_1_egk(
                    n=n, prev_symbol=symbol_prev, n_rst=ctx_rest_pos, k=k
                )
            elif fun == 'EGksymbolOrder1':
                ctx_fun = lambda n: contextselector.ctx_id_symbol_order_1_egk(
                    n=n, prev_symbol=symbol_prev, rest_pos=ctx_rest_pos,
                    symbol_max=ctx_symbol_max, k=k
                )
        ...
        symbol_prev = 0
        for i, symbol in enumerate(symbols):
            ctx_fun = ctx_fun_wrapper(
                fun=fun, symbol_prev=symbol_prev, ctx_rest_pos=ctx_rest_pos,
                ctx_symbol_max=ctx_symbol_max, k=k
            )
            if bin_id == cabac.BinarizationId.TU:
        ...
        for i in range(0, num_symbols):
            ctx_fun = ctx_fun_wrapper(
                fun=fun, symbol_prev=symbol_prev_dec,
                ctx_rest_pos=ctx_rest_pos, ctx_symbol_max=ctx_symbol_max, k=k
            )
        ...
        def ctx_fun_wrapper(fun, symbol_prev, ctx_rest_pos, ctx_symbol_max, k=0):
            if fun == 'TUBAC' or fun == 'EGkBAC':
                ...
                ctx_fun = lambda n: cabac.getContextIdBinPosition(
                    n, ctx_rest_pos
                )
            elif fun == 'TUbinsOrder1':
                ctx_fun = lambda n: cabac.getContextIdBinsOrder1TU(
                    n, symbol_prev, ctx_rest_pos
                )
            elif fun == 'TUsymbolOrder1':
                ctx_fun = lambda n: cabac.getContextIdSymbolOrder1TU(
                    n, symbol_prev, ctx_rest_pos, ctx_symbol_max
                )
            elif fun == 'EGkbinsOrder1':
                ctx_fun = lambda n: cabac.getContextIdBinsOrder1EGk(
                    n, symbol_prev, k, ctx_rest_pos
                )
            elif fun == 'EGksymbolOrder1':
        ...
        for i, symbol in enumerate(symbols):
            enc.encodeSymbol(
                symbol, [symbol_prev], bin_id, ctx_model_id,
                bin_params, ctx_params
            )
            symbol_prev = symbol
        t_enc3b = self._toc(t)
        ...
        symbol_prev_dec = 0
        for i in range(0, num_symbols):
            symbol_dec = dec.decodeSymbol(
                [symbol_prev_dec], bin_id, ctx_model_id,
                bin_params, ctx_params
            )
        ...
        print(
            ...
            f'Time overview:\n'
            f'Step 1  (bin)        : total time = {(t_enc1  + t_dec1 ):2.3f}' +
            f's (enc: {t_enc1 :2.3f}s, dec: {t_dec1 :2.3f}s)\n'
