...
class MainTest(unittest.TestCase):
    ...
    def test_ctx_selection_bins_order_n(self):
        ...
        symbols = symbolgenerator.create_random_symbols_uniform_distribution(num_values=num_values, max_val=max_val)
        ...
        for i, symbol in enumerate(symbols):
            ...
            ctx_ids = contextselector.ctx_ids_bins_order_n_tu(ctx_order, n, symbols_prev, ctx_rest_pos)
            ctx_ids2 = cabac.getContextIds(symbols_prev, bin_id, ctx_model_id, bin_params, ctx_params, len(n))
    ...
    def test_ctx_selection_symbols_order_n(self):
        ...
        for i, symbol in enumerate(symbols):
            ...
            n = list(range(0, symbol+1))
            ctx_ids = contextselector.ctx_ids_symbol_order_n_tu(ctx_order, n, symbols_prev, ctx_rest_pos, ctx_symbol_max)
            ctx_ids2 = cabac.getContextIds(symbols_prev, bin_id, ctx_model_id, bin_params, ctx_params, len(n))
            self.assertTrue((ctx_ids == np.array(ctx_ids2)).all())
    ...
    def test_ctx_selection_symbols_order_1(self):
        ...
        for i, symbol in enumerate(symbols):
            ...
            n = list(range(0, symbol+1))
            ctx_ids = contextselector.ctx_ids_symbol_order_1_tu(n, symbolPrev, num_rest, symbol_max)
