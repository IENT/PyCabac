...
namespace contextSelector{
    ...
    unsigned int getContextIdOrder1EGk(unsigned int, unsigned int, unsigned int, unsigned int);

    void getContextIdsOrder1EGk(std::vector<unsigned int>&, unsigned int, unsigned int, unsigned int, unsigned int);
};
